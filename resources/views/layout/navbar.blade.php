        ...
        <div class="collapse navbar-collapse gap-3 w-50 fs-5" id="navbarText">
            <ul class="navbar-nav">
                ...
                <li class="nav-item ps-4">
                    <a class="nav-link active {{ Request::is('writers') || Request::is('writer/*') ? 'text-decoration-underline text-primary' : ''}}" aria-current="page" href="{{ route('writersPage') }}">Writers</a>
                </li>
                <li class="nav-item ps-4">
